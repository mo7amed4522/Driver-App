...
mixin CustomTheme {
  ...
  static const MaterialColor primaryColors = MaterialColor(
    0xff01915e, // 0% comes in here, this will be color picked if no shade is selected when defining a Color property which doesn’t require a swatch.
    <int, Color>{
      50: Colors.white, //10%
      100: Colors.white, //20%
      200: Colors.white, //30%
      300: Colors.white, //40%
      400: Color(0xffF2F2F2), //50%
      500: Color(0xff01915e), //60%
      600: Color(0xff01915e), //70%
      700: Color(0xff01915e), //80%
      800: Color(0xff01915e), //90%
      900: Color(0xff01915e), //100%
    },
  );
