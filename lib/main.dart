  ...
  Widget _getOnlineOfflineButton(BuildContext context, MainState state) {
    ...
    return Mutation(
      options: MutationOptions(
        document: UPDATE_DRIVER_STATUS_MUTATION_DOCUMENT,
      ),
                ...
                ? FloatingActionButton.extended(
                    ...
                    onPressed: (result?.isLoading ?? false)
                        ...
                        : () async {
                            ...
                            final driver = UpdateDriverStatus$Mutation.fromJson(
                              res!.data!,
                            );
    ...
    if (settings.authorizationStatus == AuthorizationStatus.denied) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Text(
            S.of(context).message_notification_permission_denined_message,
          ),
          actions: [
            TextButton(
              onPressed: () {
