...
import 'package:ridy/client/components/back_button.dart';
import 'package:ridy/client/components/marker_new.dart';
import 'package:ridy/client/config.dart';
import 'package:ridy/client/map_providers.dart';
...
class TripHistoryDetailsView extends StatelessWidget {
  ...
  TripHistoryDetailsView({required this.orderId, super.key});
          ...
          Expanded(
            child: Query(
              options: QueryOptions(
                ...
                variables: GetOrderDetailsArguments(id: orderId).toJson(),
              ),
              builder:
                  (
                    QueryResult result, {
                    ...
                    final order = GetOrderDetails$Query.fromJson(result.data!)
                        .order!;
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
