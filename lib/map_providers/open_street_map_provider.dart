                      ...
                      return CircleLayer(
                        circles: <CircleMarker>[
                          CircleMarker(
                            ...
                            borderStrokeWidth: 2,
                            borderColor: CustomTheme.secondaryColors.shade200,
          ...
          listener: (context, state) {
            ...
            if (state.markers.isNotEmpty) {
              final points = state.markers
                  .map((e) => e.position)
                  .followedBy(currentLocation != null ? [currentLocation] : [])
                  .toList();
  ...
  final res = await client.mutate(
    MutationOptions(
      ...
      variables: UpdateDriverLocationArguments(
        point: PointInput(lat: position.latitude, lng: position.longitude),
      ).toJson(),
